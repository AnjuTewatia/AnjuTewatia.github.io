...
const Skills_data=[
    ...
    },
    {
        ...
        {
            id:7,
            logo:"https://github.com/VivekJawale/VivekJawale.github.io/blob/master/src/Components/Skills/tools/npm.png?raw=true",
            title:"NPM"
        }
        ]
...
const Tools = () => {
  return (
    <Box h={{base:"auto",md:"80vh"}} id="tool" mt={180}>
      <Heading
            lineHeight={1.1}
            fontWeight={600}

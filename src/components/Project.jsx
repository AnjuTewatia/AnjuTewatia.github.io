...
const project_data = [
  ...
  // },
  {
    ...
    detail:
      "KindMeal's mission how you can easily play a role in saving precious lives, and money.",
    creater: "A group project Developed within 5 days. ",
    image: IMG4,
  ...
  },
  {
    ...
    detail:
      " From Easy buy  website you can buy any product like Electronics Health and Clothes",
              ...
              <Stack flex={1} spacing={{ base: 5, md: 10 }}>
                ...
                >
                  <Button
                    ...
                    _hover={{ bg: "blue.500" }}
                  >
                    <Link href={project.deploy} isExternal>
